...
<div className="bg-white">
  <div className="border py-3 px-6">
    <div className="flex justify-between">
      ...
      <img src={img1}  className="h-10 mr-3 rounded-xl" alt="FlowBite Logo" />
        <span className="ml-2 font-semibold text-[#252C32]">Krish-Mart</span>
      </div>
      <div className="ml-6 flex flex-1 gap-x-3">
        <div className="flex cursor-pointer select-none items-center gap-x-2 rounded-md border bg-[#09ef83] py-2 px-4 text-white hover:bg-[#0fd277]">
